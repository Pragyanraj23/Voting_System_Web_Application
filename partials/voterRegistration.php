...
<body class="bg-dark">
    ...
    <div class="bg-info text-center text-dark py-3">
        <h3>Welcome to the Voter Registration System</h3>
        ...
        <div class="container my-5">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <!-- Login Form -->
                    <form action="../actions/voterRegisterDb.php" method="POST" enctype="multipart/form-data" class="bg-light p-4 rounded shadow">
                        <h4 class="mb-3">Voter Registration Form</h4>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" name="vid" placeholder="Enter your voterid" required>
                        </div>
                        <div class="mb-3">
                ...
                <!--Gender-->
                    ...
                    <!-- Extra Buttons -->
                    <div class="mt-4">
                        <a href="../partials/login.php" class="btn btn-success w-100 mb-2">Already Registerd!</a>
                    </div>
                </div>
            </div>
        </div>
